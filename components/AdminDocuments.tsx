...
export function AdminDocuments() {
  ...
  const selectedDoc = ADMIN_REGISTRY.find(d => d.id === selectedDocId);
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 animate-in fade-in duration-500 relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
        ...
        <button className="bg-[#A7705B] hover:bg-[#8B5A44] text-white px-6 py-3.5 flex items-center gap-2 rounded-full font-bold shadow-sm transition-all active:scale-95">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
        ...
        <div className="col-span-1 lg:col-span-2 bg-white rounded-[2rem] p-8 sm:p-10 shadow-sm border border-slate-100 flex flex-col justify-between overflow-hidden relative">
           ...
           <div className="relative z-10 max-w-lg">
             ...
             <h2 className="text-4xl font-black text-slate-900 mb-3 tracking-tight">24 Active Files</h2>
      ...
      <div className="bg-white rounded-[2rem] shadow-sm border border-slate-100 p-8 sm:p-10">
         <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10">
            ...
            <div className="relative max-w-md w-full sm:w-80">
              ...
              <input type="text" placeholder="Search documents..." className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-full text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#A7705B]/20 transition-shadow" />
            </div>
         </div>
                    ...
                    <tr key={doc.id} className="group hover:bg-slate-50/50 transition-colors">
                       ...
                       <td className="py-6 pr-4 text-right">
                          <div className="flex items-center justify-end gap-5">
                             <button className="text-xs font-bold tracking-widest text-[#A7705B]/40 hover:text-red-500 transition-colors">REMOVE</button>
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
           <div className="bg-white rounded-[2rem] p-8 sm:p-10 max-w-md w-full shadow-2xl relative animate-in zoom-in-95 duration-200">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                 ...
                 <button className="py-3.5 rounded-xl font-bold text-white bg-[#A7705B] hover:bg-[#8B5A44] transition-colors shadow-sm active:scale-95">
                    Overwrite File
                 </button>
              </div>
           </div>
