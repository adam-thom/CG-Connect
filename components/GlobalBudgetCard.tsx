...
export function GlobalLocationBar({ lb }: { lb: LocationBudget }) {
    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 hover:shadow-md transition-shadow">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className={`w-12 h-12 rounded-xl flex items-center justify-center font-black text-lg shadow-inner ${cfg.bg} ${cfg.text}`}>
            {cfg.label}
          </div>
          <div>
            <h3 className="font-bold text-slate-900 leading-tight">Global Facility Budget</h3>
          ...
          {editing ? (
            ...
            <div className="flex items-center gap-3 bg-slate-50 border border-slate-100 px-4 py-2 rounded-xl">
              <div className="text-right">
                <span className="block text-[10px] font-bold tracking-widest text-slate-400 mb-0.5 leading-none">BUDGET ALLOWANCE</span>
              ...
              <button
                ...
                className="w-8 h-8 flex items-center justify-center text-slate-400 hover:text-slate-700 bg-white border border-slate-200 rounded-lg transition-all shadow-sm hover:shadow"
                title="Set Budget"
              >
              ...
              <button
                onClick={handleReset}
                className="w-8 h-8 flex items-center justify-center text-slate-400 hover:text-white hover:bg-red-500 hover:border-red-500 bg-white border border-slate-200 rounded-lg transition-all shadow-sm hover:shadow"
                title="Renew Budget"
              >
