    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 bg-white p-8 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-500 max-w-xl text-lg">Central hub for overriding system parameters, deploying resources, and orchestrating profiles.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
        <Link href="/admin/users" className="group bg-white rounded-3xl p-8 border border-slate-200 shadow-sm hover:border-[#A7705B]/30 hover:shadow-md transition-all cursor-pointer flex flex-col justify-between min-h-[220px]">
           <div>
              ...
              <h2 className="text-2xl font-bold text-slate-900 mb-2">Staff Directory</h2>
        ...
        <Link href="/admin/docs" className="group bg-white rounded-3xl p-8 border border-slate-200 shadow-sm hover:border-[#A7705B]/30 hover:shadow-md transition-all cursor-pointer flex flex-col justify-between min-h-[220px]">
           <div>
              ...
              <h2 className="text-2xl font-bold text-slate-900 mb-2">Document Control</h2>
